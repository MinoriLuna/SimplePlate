...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        //Trigger Streak Warning if over 8pm.
  ...
  // No loading screen here — AppShell shows transition overlay instead
  if (isLoading) {
    return null;  // Return null during loading, AppShell shows overlay
  }
