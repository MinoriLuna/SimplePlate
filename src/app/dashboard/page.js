    ...
    <div className="h-screen bg-[#f8fafc] flex flex-col font-sans text-slate-800 overflow-hidden">
      ...
      />
        ...
        <div className="flex flex-col items-center text-center mb-8 shrink-0">
          ...
          <div className="max-w-md w-full bg-white p-3 rounded-2xl shadow-sm border border-slate-100">
        ...
        {/* 3. DASHBOARD GRID - min-h-0 allows the contents to scroll if overshooting height */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 flex-grow min-h-0">

          {/* TODAY'S LOG - Column 1 */}
          <div className="lg:col-span-7 bg-white rounded-3xl shadow-sm border border-slate-100 flex flex-col min-h-0">
            ...
            <div className="p-6 pt-2 shrink-0">
              <Link href="/logmeals" className="w-full border-2 border-dashed border-slate-200 text-slate-400 hover:text-[#00b252] hover:bg-[#00b252]/5 rounded-xl py-3 font-bold text-xs transition-all flex items-center justify-center gap-2">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6 overflow-y-auto custom-scrollbar pr-1">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex flex-col gap-3 shrink-0">
              <Link href="/logmeals" className="w-full bg-gradient-to-r from-green-600 to-indigo-600 text-white font-semibold py-3.5 rounded-xl transition-all hover:shadow-lg active:scale-95 text-sm text-center shadow-md shadow-green-100">
                Log New Meal
              </Link>
                <Link href="/history" className="py-3 bg-slate-50 text-slate-700 font-semibold rounded-xl border border-slate-200 text-center text-xs hover:bg-slate-100 transition-all">
                  History
                </Link>
                <Link href="/rewards" className="py-3 bg-slate-50 text-slate-700 font-semibold rounded-xl border border-slate-200 text-center text-xs hover:bg-slate-100 transition-all">
                  Rewards
                </Link>
              </div>
            </div>
